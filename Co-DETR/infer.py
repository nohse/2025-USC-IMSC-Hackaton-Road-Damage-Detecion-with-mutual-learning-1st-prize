...
def parse_args():
    ...
    parser.add_argument('--config', default='/home/sejong/seonghyeon/road_damage_detection/Co-DETR/configs/dino/dino-5scale_swin-l_8xb2-12e_coco.py',type=str, help="config path")
    ...
    parser.add_argument('--save_dir', default='home/sejong/seonghyeon/road_damage_detection/data/annotations_co',type=str, help="save directory")
