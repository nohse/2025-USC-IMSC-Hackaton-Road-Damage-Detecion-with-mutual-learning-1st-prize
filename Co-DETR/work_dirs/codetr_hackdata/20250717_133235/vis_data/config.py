...
launcher = 'none'
load_from = 'checkpoints/codetr_r50_coco.pth'
load_pipeline = [
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/data0/wangfj/road_damage/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
...
pretrained = '/data0/wangfj/road_damage/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth'
resume = False
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file='train.txt',
        backend_args=None,
        data_prefix=dict(ann='labels/train', img='images/train'),
        data_root=
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='val.txt',
        backend_args=None,
        data_prefix=dict(ann='labels/val', img='images/val'),
        data_root=
        '/home/sejong/seonghyeon/road_damage_detection/yolodata/hack_data',
        metainfo=dict(classes=(
            'D00',
...
val_evaluator = dict(
    _scope_='mmdet',
    ann_file=
    '/home/sejong/seonghyeon/road_damage_detection/yolodata/hack_data/val.txt',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
