...
def parse_args():
    ...
    parser.add_argument('--ckpt', default='/home/sejong/seonghyeon/road_damage_detection/data/best_coco_bbox_mAP_epoch_292.pth', type=str, help="ckpt path")
    parser.add_argument('--img_dir', default='/home/sejong/seonghyeon/road_damage_detection/data/test/img', type=str, help="image directory")
    parser.add_argument('--save_dir', default='home/sejong/seonghyeon/road_damage_detection/data/annotations_rtm', type=str, help="save directory")
    parser.add_argument('--out_dir', default='/home/sejong/seonghyeon/road_damage_detection/infer/rtdmdet_pseudo_best', type=str, help="output directory")
